# -*- coding: utf-8 -*-
"""PrasanthMLAssignment10.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1B2oSEcc73bF6anoggAg6GSeiEeSCT5NR
...
GENERATION OF RANDOM DATA FOR LINEAR MULTI LINEAR REGERSSION
"""
...
for i in range(n_features):
  ...
  X.append(X_i)
#print(X)
eps = scipy.stats.norm.rvs(0, 0.5,100)
y = 1 + (0.5 * X[0]) + eps + (0.4 * X[1]) + (0.3 * X[2]) + (0.5 * X[3])+(0.3*X[4])
...
"""GENERATION OF RANDOM DATA FOR LOGISTIC REGRESSION"""
...
"""GENERATION OF RANDOM DATA FOR K-MEANS CLUSTERING"""
...
"""LINEAR REGERSSION USING L2 REGULARIZATION"""
...
for centroid in clf.centroids:
    plt.scatter(clf.centroids[centroid][0], clf.centroids[centroid][1],
                marker="o", color="g", s=150, linewidths=5)
...
LINEAR REGRESSION FROM SCRATCH USING GRADIENT DESCENT IN OOPS
"""
...
"""LOGISTIC REGRESSION FROM SCRATCH USING GRADIENT DESCENT IN OOPS"""
...
"""K-MEANS CLUSTERING FROM SCRTACH USING OOPS"""
